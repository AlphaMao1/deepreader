...
export const SUPPORTED_FILE_EXTS = ["epub", "txt"];
...
// 阅读背景色预设
export const READING_BG_COLORS = [
  { id: "default", name: "默认", bg: "", fg: "" },
  ...
  { id: "dark-gray", name: "夜间灰", bg: "#2B2B2B", fg: "#CCCCCC" },
];
