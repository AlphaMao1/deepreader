  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        <div className="flex min-w-0 flex-1 items-center justify-center gap-x-1 px-2">
          <button
            type="button"
          ...
          <span
            title={section}
            className={`min-w-0 flex-1 truncate text-center font-medium text-sm transition-colors duration-300 ${
